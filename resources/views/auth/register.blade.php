            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="lastname" class="col-md-4 col-form-label text-md-end">Nom de famille</label>
                        ...
                        <div class="row mb-3">
                            <label for="address" class="col-md-4 col-form-label text-md-end">Adresse géographique</label>
                        ...
                        <div class="row mb-3">
                            <label for="zipcode" class="col-md-4 col-form-label text-md-end">Code postal</label>
                        ...
                        <div class="row mb-3">
                            <label for="phone_number" class="col-md-4 col-form-label text-md-end">Numéro de téléphone</label>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end">Reconfirmer Mot de passe</label>
